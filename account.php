		...
		<div class="row">
			<div class="col-md-6">
				...
				<form name="form1" id="ff1" method="POST" action="#">
					...
					<button type="submit" style="background-color: #337ab7;" name="submit" class="btn btn-1" name="login" id="login">Đăng nhập</button>
			...
			<div class="col-md-6">
				...
				<form name="form2" id="ff2" method="post" action="#">
					...
					<button type="submit" name="dangky" class="btn btn-1" style="background-color: #337ab7;">Đăng kí</button>
					<button type="submit" name="dangky" class="btn btn-1" style="background-color: #337ab7;"> <a href="Admin/login.php" >Admin</a></button>
