	...
	<div id="page-content" class="single-page">
		<div class="container">
					...
					<div class="col-md-9">
						<div class="caption">
							...
							<input class="form-inline quantity" style="margin-right: 80px;width:50px" min="1" max ="99" type="number" name ="qty[<?php echo $s["ID"] ?>]" value="<?php echo $_SESSION['cart'][$s["ID"]]?>"> 
						     <div>
								<input type="submit" name="update" style="margin-top:31px"  value="Cập nhật giỏ hàng" class="btn btn-2" />
							</div>
							<hr>
			...
			<div class="rows" style="display: flex;">
				<div class="sap" style=" display: flex;
    margin-right: 183px;">
				<div class="col-md-4 col-md-offset-8 " style="width: 9%;margin-left: 10.666667%;">
					<center><a href="index.php" class="btn btn-1" style="margin-left:-76px;    background-color: #222;
			color: #fff;
			font-size: 18px;
			padding: 10px 15px;">Chọn những sách khác</a></center>
						</div>
					<a href="rmcart.php" class="btn btn-2" style="margin-bottom:31px ;    margin-left: 5px;
			background: #D9534F;
			color: #fff;
			margin-left: 140px;
			height: 47px;
			font-size: 18px;
			padding-top: 10px;">Xóa hết giỏ hàng</a>
			...
			<div class="row"  style="    margin-bottom: 30px;">
				<div class="pricedetails" style="    margin-top: -4px;">
					<div class="col-md-4 col-md-offset-8" style="width: 102%;margin-left: 46.666667%;">
						...
						<center><a href="dathang.php" class="btn btn-1" style="width: 200px;    width: 307px;
						height: 50px;
						margin-top: 10px;
						margin-left: -27px;
						margin-bottom: 17px;
						background-color: #3366FF;">Đặt hàng</a></center>
					</div>
				</div>
			</div>
		</div> 
