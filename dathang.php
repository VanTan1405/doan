...
<form name="form6" id="ff6" method="POST" action="<?php include 'luudonhang.php' ?>">
	<div id="page-content" class="single-page">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="panel panel-default">
						<div class="panel-heading" style="font-weight: bold;">Thông tin khách hàng</div>
				...
				<div class="col-lg-5">
					<div class="panel panel-default">
						<div class="panel-heading" style="font-weight: bold;">Thông tin đơn hàng</div>
						<div class="panel-body">
							<div class="col-md-12">
			...
			<input type="submit" style="background-color: #3366FF; width: 100%;" id="hover" name="Dat" value="Đặt hàng" class="btn btn-1" />
		</div>
	</div>
</form>
<?php
