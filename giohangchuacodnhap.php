	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-8 ">
				...
				<center>
					<p style="color:red"><i class="fa fa-exclamation" aria-hidden="true" style="margin-left: 77px;"> Bạn cần đăng nhập để đặt hàng</i></p>
					<a href="index.php" class="btn btn-1" style="    margin-left: 66px;
    background-color: #222;
    color: #fff;
    font-size: 18px;
    padding: 10px 15px;
    width: 306px;">Chọn những sách khác</a>
				</center>
			</div>
			<div class="row">
				<div class="pricedetails">
					<div class="col-md-4 col-md-offset-8" style="width: 102%;margin-left: 71.666667%;">
						...
						<center>
							<a href="account.php" class="btn btn-1" style="width: 200px;    width: 307px;
						height: 50px;
						margin-top: 10px;
						margin-right: 968px;
						margin-bottom: 17px;
						background-color: #3366FF;">Vào trang đăng nhập</a>
						</center>
