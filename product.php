...
<div id="page-content" class="single-page">
   ...
   LEFT JOIN nhaxuatban n on n.ID = s.Manhasx
	...
	if (isset($_POST['submit'])) {
		...
		echo "<script>window.location.replace('http://localhost/BanSachOnline/cart.php'); </script>";
	}
		...
		<div class="row">
			...
			<div id="main-content" class="col-md-8">
				<div class="product">
					...
					<div class="col-md-6" style="width: 44%;" id="sty">
						<div class="caption">
							<div class="name">
							...
							?>
								<div class="price" style="	font-size: 17px;
									...
									<?php echo $row["giakhuyenmai"] ?>.000 VNĐ<span><?php echo $row["Gia"] ?>.000 VNĐ</span></div>
							<?php
							}
							?>
							<?php
				...
				<div class="product-desc">
					<ul class="nav nav-tabs">
						<li class="active"><a style="background-color: #777;" href="#description">Thông tin sách</a></li>
					</ul>
