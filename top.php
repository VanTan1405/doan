...
<nav id="top" style="background-color: #337ab7;">
		<div class="container">
			<div class="row">
				<div class="col-xs-6">
						...
						<?php
							 // require "login.php";
							      if(!isset($_SESSION['txtus'])) // If session is not set then redirect to Login Page
							       {
							           printf(' <li><a href="account.php" style="color: white;"><span class="glyphicon glyphicon-log-in"></span> Đăng nhập</a></li>
										<li><a href="contact.php" style="color: white;"><span class="glyphicon glyphicon-envelope"></span> Liên hệ</a></li>');
							       }
							       else{
